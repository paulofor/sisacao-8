...
(
  ...
  event_volume_spike_20d FLOAT64,
  event_financial_volume_spike_z20 FLOAT64,
  event_abs_return_5d_ge_10 FLOAT64,
  event_tail_risk_score FLOAT64,
...
ADD COLUMN IF NOT EXISTS event_volume_spike_20d FLOAT64,
ADD COLUMN IF NOT EXISTS event_financial_volume_spike_z20 FLOAT64,
ADD COLUMN IF NOT EXISTS event_abs_return_5d_ge_10 FLOAT64,
ADD COLUMN IF NOT EXISTS event_tail_risk_score FLOAT64,
