...
def test_build_training_dataset_creates_features_labels_and_splits() -> None:
    ...
    assert dataset["feature_version"].eq("feature_eod_tabular_v4").all()
    ...
    assert "event_tail_risk_score" in dataset.columns
...
def test_dataset_manifest_records_phase2_point_in_time_controls() -> None:
    ...
    assert manifest["feature_version"] == "feature_eod_tabular_v4"
